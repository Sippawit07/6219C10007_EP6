//สร้างตัวแปรอ้างอิงไปยังตำแหน่งแต่ละคอนเทนต์ที่หน้าเว็บเพจ เพื่อเขียน javascript ควบคุทการทำงาน
...
tx_quiz.onkeydown = (evt) => {
    // เอา evt ซึ่งเป็นปุ่มที่ผู้ใช้กดมาพิสูจน์ว่าเป็นตัวเลขหรือไม่ 
   // console.log(evt)
    ...
    && evt.key != 'Delete' 
    && evt.key != 'ArrowRight' 
    && evt.key != 'ArrowLeft'){ //NaN -> not a number
        evt.preventDefault()
    }
}

function calScoreGrade(){
    //คำนวณคะแนนรวม และเกรด
